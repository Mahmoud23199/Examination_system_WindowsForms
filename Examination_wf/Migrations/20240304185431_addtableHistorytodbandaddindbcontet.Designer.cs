...
namespace Examinationwf.Migrations
{
    ...
    [Migration("20240304185431_addtableHistorytodbandaddindbcontet")]
    partial class addtableHistorytodbandaddindbcontet
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Examination_wf.ExamHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Examination_wf.ExamHistory", b =>
                {
                    b.HasOne("Examination_wf.Course", "Course")
                        .WithOne("ExamHistory")
                        .HasForeignKey("Examination_wf.ExamHistory", "CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
